        ...
        <div className="box-border max-w-screen-xl mx-auto">
          <div className="box-border gap-x-6 grid grid-cols-[repeat(1,minmax(0px,1fr))] gap-y-6 md:gap-x-10 md:grid-cols-[repeat(2,minmax(0px,1fr))] md:gap-y-10">
            <div className="self-center box-border">
              ...
              <a href="#products" className="relative text-white text-sm font-bold items-center bg-indigo-500 box-border gap-x-2 hidden justify-center tracking-[0.6px] leading-[22px] gap-y-2 uppercase w-full z-[1] border-indigo-500 overflow-hidden mt-8 px-[15px] py-5 rounded-full border-2 border-solid md:text-xl md:inline-flex md:leading-7 md:w-auto md:px-16">
            ...
            <div className="text-white items-center box-border justify-self-end w-full">
              ...
              <div className="text-black bg-white box-border max-w-none ml-0 mt-4 p-3 rounded-bl rounded-br rounded-tl rounded-tr md:max-w-[460px] md:ml-auto">
                <div className="text-indigo-500 text-lg font-bold items-baseline box-border flex justify-between tracking-[0.9px] leading-7">
            ...
            <a href="#products" className="relative text-white text-sm font-bold items-center bg-indigo-500 box-border gap-x-2 flex justify-center tracking-[0.6px] leading-[22px] min-h-[auto] min-w-[auto] gap-y-2 uppercase w-full z-[1] border-indigo-500 overflow-hidden px-[15px] py-5 rounded-full border-2 border-solid md:text-xl md:hidden md:leading-7 md:min-h-0 md:min-w-0 md:w-auto md:px-16">
              I WANT BABY SMOOTH SKIN NOW
              <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-8.svg" alt="Icon" className="text-sm box-border h-4 leading-[22px] md:text-xl md:h-[18px] md:leading-7" />
            </a>
          </div>
