  ...
  return (
    <section className="box-border">
      <div className="relative box-border">
        ...
        <div className="bg-indigo-500/10 box-border">
          <div className="relative box-border max-w-screen-xl mx-auto px-6 py-10">
            <div className="box-border gap-x-8 grid grid-cols-none justify-center gap-y-8 md:grid-cols-[repeat(5,minmax(0px,1fr))]">
              ...
              <div className="self-center box-border col-end-auto col-start-auto md:col-end-[span_3] md:col-start-[span_3]">
                ...
                <a href="#products" className="relative text-white text-sm font-bold items-center bg-indigo-500 box-border gap-x-2 inline-flex justify-center tracking-[0.6px] leading-[22px] gap-y-2 uppercase w-full z-[1] border-indigo-500 overflow-hidden mt-7 px-[15px] py-5 rounded-full border-2 border-solid md:text-xl md:leading-7 md:w-auto md:px-16">
