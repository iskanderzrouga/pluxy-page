...
export function ComparisonSection() {
  return (
    <div className="box-border">
      <div className="bg-stone-100 box-border px-5 py-8 md:py-[60px]">
        <div className="items-center box-border gap-x-[30px] flex flex-col max-w-[1240px] gap-y-[30px] w-full mx-auto md:gap-x-[50px] md:gap-y-[50px]">
          <div className="box-border gap-x-5 flex flex-col justify-center gap-y-5 text-center">
            <h2 className="text-neutral-800 text-[26px] font-bold box-border leading-[32.5px] md:text-[40px] md:leading-[50px]">Why Pluxy Epil Pro Stands Out</h2>
            <p className="text-neutral-800 text-lg box-border leading-[22.5px] md:text-xl md:leading-[25px]">
              Most epilators can damage your skin. Pluxy Epil Pro 3.0 is different. Here’s why:
            </p>
          </div>
          <div className="items-center box-border gap-x-[30px] flex flex-col gap-y-[30px] pb-8 md:gap-x-[50px] md:gap-y-[50px] md:pb-0">
            <div className="items-center box-border flex flex-col justify-center md:items-start">
              <div className="sticky box-border top-4">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/45.webp" alt="" className="relative box-border max-w-full w-full rounded-xl md:max-w-[720px]" />
              </div>
            </div>
            <div className="box-border max-w-[350px] w-full mx-auto md:max-w-none">
              <div role="region" className="relative box-border">
          ...
          <div className="items-center box-border flex flex-col">
            ...
            <ul className="items-center box-border gap-x-2 flex flex-wrap justify-center list-none gap-y-2 mt-5 pl-0">
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-32.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-33.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-34.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-35.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-36.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-37.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-38.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-39.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-40.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-41.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
              <li className="box-border text-left">
                <img src="https://c.animaapp.com/mdqy9698UVjprT/assets/icon-42.svg" alt="Icon" className="box-border h-6 w-[38px]" />
              </li>
            </ul>
          </div>
        </div>
